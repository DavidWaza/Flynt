...
export default function DashboardLayout({
  ...
  return (
    <div className="flex min-h-screen bg-bg-primary">
      {/* Sidebar */}
      <aside
        className="fixed left-0 top-0 z-40 h-screen w-64 b
      \ `order-r border-border-primary bg-bg-secondary shadow-sm"
      >
        ...
        <header className="sticky top-0 z-30 border-b border-border-primary bg-white/80 dark:bg-bg-secondary/80 backdrop-blur-xl shadow-sm">
          <div className="flex h-16 items-center justify-between px-6">
            ...
            <div className="flex items-center gap-3">
              ...
              {/* Search */}
              <button className="flex h-9 w-9 items-center justify-center rounded-lg text-text-secondary transition-colors hover:bg-bg-elevated hover:text-text-primary">
                <svg
                  className="h-5 w-5"
                  fill="none"
                  viewBox="0 0 24 24"
              ...
              {/* Notifications */}
              <button className="relative flex h-9 w-9 items-center justify-center rounded-lg text-text-secondary transition-colors hover:bg-bg-elevated hover:text-text-primary">
                <svg
                  className="h-5 w-5"
                  fill="none"
                  viewBox="0 0 24 24"
