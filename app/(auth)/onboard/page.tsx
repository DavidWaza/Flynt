							...
							<div className="flex flex-col items-center text-center">
								...
								<div className="mt-6 flex w-full flex-col gap-3">
									...
									<button
										...
										className="text-sm font-medium text-text-secondary hover:text-text-primary focus:outline-none focus:ring-2 focus:ring-green-primary/20 rounded"
									>
										&lt; Back
									</button>
								</div>
								...
								<div className="mt-6 space-y-4">
									<div ref={bankDropdownRef} className="relative">
										...
										<button
											...
											className="flex w-full items-center gap-3 rounded-xl border border-border-primary bg-bg-card py-2.5 pl-10 pr-4 text-left text-sm text-text-primary placeholder:text-text-muted focus:outline-none focus:ring-2 focus:ring-green-primary/20 focus:border-green-primary"
										...
										>
											...
											<span className={!selectedBank ? "text-text-muted" : ""}>
										...
										{bankDropdownOpen && (
											<ul
												className="absolute z-10 mt-1 w-full rounded-xl border border-border-primary bg-bg-card py-1 shadow-lg max-h-48 overflow-auto"
												role="listbox"
											>
												{BANKS.map((bank) => (
													<li
									...
									<button
										type="button"
										onClick={() => setCurrentStep(3)}
										className="w-full text-center text-sm font-medium text-text-secondary hover:text-text-primary focus:outline-none focus:ring-2 focus:ring-green-primary/20 rounded"
									>
										&lt; Back
									</button>
								</div>
